...
- messageConverterConfigurer:消息转换器的配置类,默认 MessageConverterConfigurer
- compositeMessageChannelConfigurer:聚合管道的配置类,将StreamFunctionProperties配置的信息进行绑定管道

![image-20240304150142738](images/image-20240304150142738.png)
...
### 6.1 DirectWithAttributesChannel
